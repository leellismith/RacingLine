...
## <p align='center'>[Racing Line Repository](https://github.com/leellismith/RacingLine)
...
# Test Cases
  ...
  |:---      |---     | 
  | Navbar Links navigate to correct pages.  | Passed  |
  | Book Now Button that navigates to booking page. |  Passed |
  | Footer Links navigates to the correct website. | Passed  |
  | Form Booking button links to form dump page. | Passed |

  ---

  | Case Testing Responsivenes | Result |
  |---       | ---       |
  | Image responsivenes at min-width: 768px | Passed |
  | Image responsivenes at min-width: 1400px | Passed |
  | Font responsivenes at min-width: 768px | Passed |
  | Form respinsivenes at min-width: 768px | Passed

  ---

  # User Testing

  __Website was sent to 5 users to test and find bugs on website__

  | Users | Results | Fixed Issues
  |---|---|---|
  | First User | User found bug with form overlap | Fixed |
  | Second User | No Issues | N/A |
  | Third User | No Issues | N/A |
  | Fourth User | No Issues | N/A |
  | Fifth User | No Issues | N/A |
...
## 1st Gallery Image
![Gallery First Picture](assets/images/galleryimg1.jpg)
## 2nd Gallery Image
![Gallery Second Picture](assets/images/galleryimg2.jpg)
## Booking Track Image
![Booking Image](assets/images/bookingimg.jpg)
